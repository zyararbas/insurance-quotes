...
from app.models.models import RatingInput, Vehicle, Usage, Coverages
...
class CoverageCalculationAggregator:
    ...
    def calculate_coverage_premiums(self, rating_input: RatingInput) -> Dict:
        ...
        logger.info(f"calculate_coverage_premiums Rating input ------ \n{rating_input}");
        ...
        if carrier == "STATEFARM":
            ...
            from app.services.calculations.carrier_price_estimation_service import CarrierPriceEstimationService
