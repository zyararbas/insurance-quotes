...
from app.services.py_pricing_service.models.models import Discounts
import logging
...
class DiscountService:
    ...
    def calculate_discount_factors(self, discounts: Discounts, special_factors, coverages: List[str]) -> Dict:
        ...
        for coverage in coverages:
            ...
            coverage_discounts['mature_driver_course'] = mature_driver_factor
    ...
    def _calculate_loyalty_discount(self, loyalty_years: int, coverage: str) -> float:
        ...
        try:
            ...
            loyalty_data = self.data_loader.load_loyalty_discount_factors()
